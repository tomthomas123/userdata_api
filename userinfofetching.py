...
for i in data_info["users"]:
    ...
    hair = i['hair']
    chair = hair['color']
    sql = "INSERT INTO `userdata_fetch`(`first_name`, `last_name`, `maidenName`, `user_name`, `password`, `birthdate`, `hair`) VALUES (%s,%s,%s,%s,%s,%s,%s)" #('"+i['firstName']+"','"+i['lastName']+"','"+i['maidenName']+"','"+i['username']+"','"+i['password']+"','"+i['birthDate']+"','"+chair+"')"
